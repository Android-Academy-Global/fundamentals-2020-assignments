...
class Workshop1ProfileSolutionFragment : Fragment(R.layout.fragment_workshop_1_profile) {
    ...
    companion object {
        fun newInstance(): Workshop1ProfileSolutionFragment = Workshop1ProfileSolutionFragment()
    }
}
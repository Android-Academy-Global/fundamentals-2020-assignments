...
class WS01Step02ActivityA : AppCompatActivity() {
    ...
    private fun setupUi() {
        btnStartA = findViewById<AppCompatButton>(R.id.btn_start_a).apply {
            setOnClickListener {
                startActivity(Intent(this@WS01Step02ActivityA, WS01Step02ActivityA::class.java))
            }
        }
        ...
        btnStartC = findViewById<AppCompatButton>(R.id.btn_start_c).apply {
            setOnClickListener {
                startActivity(Intent(this@WS01Step02ActivityA, WS01Step02ActivityC::class.java))
            }
        }
        btnStartD = findViewById<AppCompatButton>(R.id.btn_start_d).apply {
            setOnClickListener {
                startActivity(Intent(this@WS01Step02ActivityA, WS01Step02ActivityD::class.java))
            }
        }
    }

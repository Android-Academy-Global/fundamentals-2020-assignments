package com.android.academy.fundamentals.workshop04.solution
...
class WS04ErrorHandlingSolutionFragment : Fragment(R.layout.fragment_coroutines_error_handling) {
